...
function App() {
  ...
  return (
    ...
    <div className="bg-orange-500 p-8 grid grid-cols-4 gap-4">
      <div>
      <Card 
        props={{image:"https://chobs.mistoremx.com/images/202501/goods_img/1677_P_1736368852324.jpg",
                title:'Poco X7 PRO',
                paragraph:"Celular de gama media enfocado en el rendimiento y duración de la batería.",
                productRef:"#"
              }}/>
      {products.map(e => <Card props={{image:e.b64Image,
                                       title:e.name,
